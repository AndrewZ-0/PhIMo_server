...
class PhimoServer:
    ...
    #legacy
    """
    def handle_client_disconnect(self, client_ip):
    ...
    def handle_client_disconnect_route(self):
        client_ip = request.remote_addr
        self.handle_client_disconnect(client_ip)
    ...
    def list_project_simulations(self):
        userId = request.headers["certificate"]
        projectName = request.headers["projectName"]
    ...
    def stream_simulationFramesFile(self):
        headers = request.headers
        userId = headers["certificate"]
        projectName = headers["projectName"]
        simulationName = headers["simulationName"]
    ...
    def get_certificateCookie(self):
    ...
    def update_accessProjectTime(self):
        headers = request.headers
        data = request.json
        userId = headers["certificate"]
        projectName = data["projectName"]
    ...
    def update_simulationSettings(self):
        headers = request.headers
        data = request.json
        userId = headers["certificate"]
        projectName = data["projectName"]
    ...
    def get_projectScreenshot(self):
        userId = request.headers["certificate"]
        projectName = request.headers["projectName"]
    ...
    def stop_computing_simulation(self):
        headers = request.headers
        data = request.json
        userId = headers["certificate"]
    ...
    def get_simComputing_progress(self):
        userId = request.headers["certificate"]
    ...
    def update_accessSimulationTime(self):
        headers = request.headers
        data = request.json
        userId = headers["certificate"]
        projectName = data["projectName"]
